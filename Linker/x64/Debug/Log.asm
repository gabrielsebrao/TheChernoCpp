...
PUBLIC	?InitLog@@YAXPEBD@Z				; InitLog
...
;	COMDAT pdata
pdata	SEGMENT
$pdata$?InitLog@@YAXPEBD@Z DD imagerel $LN3
	DD	imagerel $LN3+53
	DD	imagerel $unwind$?InitLog@@YAXPEBD@Z
pdata	ENDS
;	COMDAT pdata
pdata	SEGMENT
...
;	COMDAT xdata
xdata	SEGMENT
$unwind$?InitLog@@YAXPEBD@Z DD 025051301H
	DD	010e2313H
	DD	07007001dH
	DD	05006H
xdata	ENDS
...
text$x	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
;	COMDAT ?InitLog@@YAXPEBD@Z
_TEXT	SEGMENT
message$ = 224
?InitLog@@YAXPEBD@Z PROC				; InitLog, COMDAT
; File C:\Dev\CppTutorialCherno\Linker\Log.cpp
; Line 5
$LN3:
	mov	QWORD PTR [rsp+8], rcx
	push	rbp
	...
	sub	rsp, 232				; 000000e8H
	lea	rbp, QWORD PTR [rsp+32]
	lea	rcx, OFFSET FLAT:__9510FCE5_Log@cpp
	call	__CheckForDebuggerJustMyCode
; Line 6
...
; Line 7
	...
	pop	rbp
	ret	0
?InitLog@@YAXPEBD@Z ENDP				; InitLog
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
