...
__2BAE2D51_Log@h DB 01H
__0982A804_Main@cpp DB 01H
msvcjmc	ENDS
...
PUBLIC	??_C@_0BN@FGNNFOIM@Choose?5player?8s?5x?5position?3?5@ ; `string'
PUBLIC	??_C@_0BN@ILELIHAJ@Choose?5player?8s?5y?5position?3?5@ ; `string'
PUBLIC	??_C@_0BI@JNPINBIP@Choose?5player?8s?5speed?3?5@ ; `string'
PUBLIC	??_C@_0CC@FDELBOHH@What?5x?5power?5will?5player?5get?$DP?5?9@ ; `string'
PUBLIC	??_C@_0CC@DAEMMHFD@What?5y?5power?5will?5player?5get?$DP?5?9@ ; `string'
PUBLIC	??_C@_02DMCFFCKO@?$CJ?4@			; `string'
PUBLIC	??_C@_01IHBHIGKO@?0@				; `string'
PUBLIC	??_C@_0BG@FCKCDCKD@Now?0?5player?8s?5is?5at?5?$CI@ ; `string'
EXTRN	strlen:PROC
...
;	COMDAT pdata
pdata	SEGMENT
$pdata$?Move@Player@@QEAAXHH@Z DD imagerel $LN3
	DD	imagerel $LN3+126
	DD	imagerel $unwind$?Move@Player@@QEAAXHH@Z
pdata	ENDS
;	COMDAT pdata
pdata	SEGMENT
...
rtc$IMZ	ENDS
;	COMDAT ??_C@_0BG@FCKCDCKD@Now?0?5player?8s?5is?5at?5?$CI@
CONST	SEGMENT
??_C@_0BG@FCKCDCKD@Now?0?5player?8s?5is?5at?5?$CI@ DB 'Now, player''s is '
	DB	'at (', 00H					; `string'
CONST	ENDS
...
CONST	ENDS
;	COMDAT ??_C@_02DMCFFCKO@?$CJ?4@
CONST	SEGMENT
??_C@_02DMCFFCKO@?$CJ?4@ DB ').', 00H			; `string'
CONST	ENDS
;	COMDAT ??_C@_0CC@DAEMMHFD@What?5y?5power?5will?5player?5get?$DP?5?9@
CONST	SEGMENT
??_C@_0CC@DAEMMHFD@What?5y?5power?5will?5player?5get?$DP?5?9@ DB 'What y '
	DB	'power will player get? -> ', 00H		; `string'
CONST	ENDS
;	COMDAT ??_C@_0CC@FDELBOHH@What?5x?5power?5will?5player?5get?$DP?5?9@
CONST	SEGMENT
??_C@_0CC@FDELBOHH@What?5x?5power?5will?5player?5get?$DP?5?9@ DB 'What x '
	DB	'power will player get? -> ', 00H		; `string'
CONST	ENDS
;	COMDAT ??_C@_0BI@JNPINBIP@Choose?5player?8s?5speed?3?5@
CONST	SEGMENT
??_C@_0BI@JNPINBIP@Choose?5player?8s?5speed?3?5@ DB 'Choose player''s spe'
	DB	'ed: ', 00H					; `string'
CONST	ENDS
;	COMDAT ??_C@_0BN@ILELIHAJ@Choose?5player?8s?5y?5position?3?5@
CONST	SEGMENT
??_C@_0BN@ILELIHAJ@Choose?5player?8s?5y?5position?3?5@ DB 'Choose player'''
	DB	's y position: ', 00H			; `string'
CONST	ENDS
;	COMDAT ??_C@_0BN@FGNNFOIM@Choose?5player?8s?5x?5position?3?5@
CONST	SEGMENT
??_C@_0BN@FGNNFOIM@Choose?5player?8s?5x?5position?3?5@ DB 'Choose player'''
	DB	's x position: ', 00H			; `string'
CONST	ENDS
;	COMDAT xdata
xdata	SEGMENT
...
;	COMDAT xdata
xdata	SEGMENT
$unwind$?Move@Player@@QEAAXHH@Z DD 025051c01H
	DD	0117231cH
	DD	07010001dH
	DD	0500fH
xdata	ENDS
...
__$ArrayPad$ = 296
main	PROC						; COMDAT
; File C:\Dev\CppTutorialCherno\Linker\Main.cpp
; Line 18
$LN3:
	push	rbp
	push	rdi
	...
	xor	rax, rbp
	mov	QWORD PTR __$ArrayPad$[rbp], rax
	lea	rcx, OFFSET FLAT:__0982A804_Main@cpp
	call	__CheckForDebuggerJustMyCode
; Line 23
	lea	rdx, OFFSET FLAT:??_C@_0BN@FGNNFOIM@Choose?5player?8s?5x?5position?3?5@
	mov	rcx, QWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	call	??$?6U?$char_traits@D@std@@@std@@YAAEAV?$basic_ostream@DU?$char_traits@D@std@@@0@AEAV10@PEBD@Z ; std::operator<<<std::char_traits<char> >
; Line 24
	lea	rdx, QWORD PTR player$[rbp]
...
; Line 26
	lea	rdx, OFFSET FLAT:??_C@_0BN@ILELIHAJ@Choose?5player?8s?5y?5position?3?5@
	mov	rcx, QWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	call	??$?6U?$char_traits@D@std@@@std@@YAAEAV?$basic_ostream@DU?$char_traits@D@std@@@0@AEAV10@PEBD@Z ; std::operator<<<std::char_traits<char> >
; Line 27
	lea	rdx, QWORD PTR player$[rbp+4]
	mov	rcx, QWORD PTR __imp_?cin@std@@3V?$basic_istream@DU?$char_traits@D@std@@@1@A
	call	QWORD PTR __imp_??5?$basic_istream@DU?$char_traits@D@std@@@std@@QEAAAEAV01@AEAH@Z
; Line 29
	lea	rdx, OFFSET FLAT:??_C@_0BI@JNPINBIP@Choose?5player?8s?5speed?3?5@
	mov	rcx, QWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	call	??$?6U?$char_traits@D@std@@@std@@YAAEAV?$basic_ostream@DU?$char_traits@D@std@@@0@AEAV10@PEBD@Z ; std::operator<<<std::char_traits<char> >
; Line 30
	lea	rdx, QWORD PTR player$[rbp+8]
	mov	rcx, QWORD PTR __imp_?cin@std@@3V?$basic_istream@DU?$char_traits@D@std@@@1@A
	call	QWORD PTR __imp_??5?$basic_istream@DU?$char_traits@D@std@@@std@@QEAAAEAV01@AEAH@Z
; Line 32
	lea	rdx, OFFSET FLAT:??_C@_0CC@FDELBOHH@What?5x?5power?5will?5player?5get?$DP?5?9@
	mov	rcx, QWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	call	??$?6U?$char_traits@D@std@@@std@@YAAEAV?$basic_ostream@DU?$char_traits@D@std@@@0@AEAV10@PEBD@Z ; std::operator<<<std::char_traits<char> >
; Line 33
	lea	rdx, QWORD PTR xPower$[rbp]
	mov	rcx, QWORD PTR __imp_?cin@std@@3V?$basic_istream@DU?$char_traits@D@std@@@1@A
	call	QWORD PTR __imp_??5?$basic_istream@DU?$char_traits@D@std@@@std@@QEAAAEAV01@AEAH@Z
; Line 35
	lea	rdx, OFFSET FLAT:??_C@_0CC@DAEMMHFD@What?5y?5power?5will?5player?5get?$DP?5?9@
	mov	rcx, QWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	call	??$?6U?$char_traits@D@std@@@std@@YAAEAV?$basic_ostream@DU?$char_traits@D@std@@@0@AEAV10@PEBD@Z ; std::operator<<<std::char_traits<char> >
; Line 36
	lea	rdx, QWORD PTR yPower$[rbp]
	mov	rcx, QWORD PTR __imp_?cin@std@@3V?$basic_istream@DU?$char_traits@D@std@@@1@A
	call	QWORD PTR __imp_??5?$basic_istream@DU?$char_traits@D@std@@@std@@QEAAAEAV01@AEAH@Z
; Line 38
	mov	r8d, DWORD PTR yPower$[rbp]
	mov	edx, DWORD PTR xPower$[rbp]
	lea	rcx, QWORD PTR player$[rbp]
	call	?Move@Player@@QEAAXHH@Z			; Player::Move
; Line 39
	lea	rdx, OFFSET FLAT:??_C@_0BG@FCKCDCKD@Now?0?5player?8s?5is?5at?5?$CI@
	mov	rcx, QWORD PTR __imp_?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A
	call	??$?6U?$char_traits@D@std@@@std@@YAAEAV?$basic_ostream@DU?$char_traits@D@std@@@0@AEAV10@PEBD@Z ; std::operator<<<std::char_traits<char> >
	mov	edx, DWORD PTR player$[rbp]
	mov	rcx, rax
	call	QWORD PTR __imp_??6?$basic_ostream@DU?$char_traits@D@std@@@std@@QEAAAEAV01@H@Z
	lea	rdx, OFFSET FLAT:??_C@_01IHBHIGKO@?0@
	mov	rcx, rax
	call	??$?6U?$char_traits@D@std@@@std@@YAAEAV?$basic_ostream@DU?$char_traits@D@std@@@0@AEAV10@PEBD@Z ; std::operator<<<std::char_traits<char> >
	mov	edx, DWORD PTR player$[rbp+4]
	mov	rcx, rax
	call	QWORD PTR __imp_??6?$basic_ostream@DU?$char_traits@D@std@@@std@@QEAAAEAV01@H@Z
	lea	rdx, OFFSET FLAT:??_C@_02DMCFFCKO@?$CJ?4@
	mov	rcx, rax
	call	??$?6U?$char_traits@D@std@@@std@@YAAEAV?$basic_ostream@DU?$char_traits@D@std@@@0@AEAV10@PEBD@Z ; std::operator<<<std::char_traits<char> >
; Line 40
	xor	eax, eax
...
xa$ = 232
ya$ = 240
?Move@Player@@QEAAXHH@Z PROC				; Player::Move, COMDAT
; File C:\Dev\CppTutorialCherno\Linker\Main.cpp
; Line 11
$LN3:
...
; Line 14
	...
	pop	rbp
	ret	0
?Move@Player@@QEAAXHH@Z ENDP				; Player::Move
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
